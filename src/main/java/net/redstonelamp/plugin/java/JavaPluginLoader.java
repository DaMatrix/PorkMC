...
public class JavaPluginLoader extends PluginLoader{
    ...
    public HashMap<String, Plugin> loadPlugins() throws PluginException, IOException{
        ...
        HashMap<Plugin, String> mains = new HashMap<>(); // Debugging,
        // only
        // for
        // loading
        // plugins.
        HashMap<Plugin, File> files = new HashMap<>(); // Debugging,
        // only for
        // adding
        // dependencies.
        for(File file : folder.listFiles()){
            if(file.getName().endsWith(".jar")){
                ...
                HashMap<String, Object> yaml = (HashMap<String, Object>) new YamlReader(
                        IOUtils.toString(loader.getResourceAsStream("plugin.yml"))).read();
