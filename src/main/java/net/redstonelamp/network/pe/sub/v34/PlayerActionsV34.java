...
/**
 * List of actions in PlayerActionPacket for protocol version 34.
 * <br>
 * From PocketMineProject, original can be found at: https://github.com/PocketMine/PocketMine-MP/blob/mcpe-0.12/src/pocketmine/network/protocol/PlayerActionPacket.php
 *
...
public class PlayerActionsV34{
    ...
    public static final int ACTION_DIMENSION_CHANGE = 13;
}
