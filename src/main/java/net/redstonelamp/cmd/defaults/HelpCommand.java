...
public class HelpCommand implements CommandExecutor{
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args){
        if(label.equalsIgnoreCase("help")){
            ...
            if(commands != null){
                ...
                sender.sendMessage(new ChatResponse.ChatTranslation(
                        TextFormat.GREEN + "redstonelamp.translation.command.help.header", new String[]{
                        String.valueOf(page + 1), String.valueOf(getPages())
                }
                ));
                for(Command command : commands){
                    if(command != null){
                        ...
                        sender.sendMessage(new ChatResponse.ChatTranslation(
                                "redstonelamp.translation.command.help.listEntry", new String[]{
                ...
                sender.sendMessage(new ChatResponse.ChatTranslation(
                        "redstonelamp.translation.command.help.invalidPage", new String[]{
    ...
    private int getPages(){
        Command[] cmds = Command.getCommands();
        return (int) Math.ceil((double) cmds.length / 10);
    }
}